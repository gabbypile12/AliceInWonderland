  ...
  return (
    <div className="landing-page">
      ...
      <Table>
        <tbody>
          <tr>
            <Link id="theLink" to="/game-page">
              <td
                className={`my-div ${isHovering ? "hovered" : ""}`}
            ...
            <Link id="theLink" to="/game-page">
              <td
                className={`my-div ${isHovering2 ? "hovered" : ""}`}
                onMouseEnter={() => setIsHovering2(true)}
                onMouseLeave={() => setIsHovering2(false)}
              >
                {" "}
                <img src={WhiteRabbit} className="landPageImage2" />{" "}
                <h2> Python </h2>
              </td>
            </Link>
          </tr>
          ...
          <tr>
            <Link id="theLink" to="/game-page">
              <td
                className={`my-div ${isHovering3 ? "hovered" : ""}`}
                onMouseEnter={() => setIsHovering3(true)}
                onMouseLeave={() => setIsHovering3(false)}
              >
                {" "}
                <img src={QueenOfHeartes} className="landPageImage2" />{" "}
            ...
            <Link id="theLink" to="/game-page">
              <td
                className={`my-div ${isHovering4 ? "hovered" : ""}`}
                onMouseEnter={() => setIsHovering4(true)}
                onMouseLeave={() => setIsHovering4(false)}
              >
                {" "}
                <img src={MadHatterRemoved} className="landPageImage3" />{" "}
                <h2>Study Tips</h2>
              </td>{" "}
            </Link>
          </tr>
